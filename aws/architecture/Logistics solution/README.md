...
Base de Datos: Amazon Aurora PostgreSQL Serverless v2 para un escalado dinámico y eficiente, eliminando el aprovisionamiento manual de capacidad.
...
![Diagrama de Arquitectura](docs/images/Diseño_arquitectónico/logistica.png)
...
Planificar cambios: terraform plan -out=tfplan

Aplicar despliegue: terraform apply "tfplan"

Autor: Idelfonso Guardo